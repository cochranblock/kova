...
pub const SYNTH_ROUTER_PAIRS: &[(&str, &str)] = &[
    ...
    ("fix the typo in comment", "edit_file"),
    ...
    ("find all rust source files", "glob"),
    ...
    ("google for tokio examples", "web_search"),
    ("look up the latest serde docs online", "web_search"),
    ("find an answer on stackoverflow", "web_search"),
